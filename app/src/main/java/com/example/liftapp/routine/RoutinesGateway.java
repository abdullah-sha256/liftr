...
import com.example.liftapp.constants.DatabaseConstants;
import com.example.liftapp.profile.Loadable;
import com.example.liftapp.profile.Saveable;
import com.example.liftapp.workout.workout_template.FirebaseWorkoutGetter;
 ...
 * @since 0.5
 */
class RoutinesGateway implements Loadable, Saveable {
     ...
     *
     * @param presenter StartWorkoutFromRoutinesPresenter that allows the program to use the routines
     */
    RoutinesGateway(LoadsRoutines presenter) {
