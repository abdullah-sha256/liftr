package com.example.liftapp.workout.workout_template;
...
class WorkoutTemplateGateway implements Loadable, Saveable {
     ...
     */
    WorkoutTemplateGateway(LoadsWorkoutTemplate presenter, String workoutName, String routineName) {
