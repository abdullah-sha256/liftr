package com.example.liftapp.routine;
...
import com.example.liftapp.profile.DashboardActivity;
import com.example.liftapp.workout.track_workout.TrackWorkoutActivity;
import com.example.liftapp.workout.workout_template.AddWorkoutActivity;
import com.example.liftapp.workout.workout_template.ViewWorkoutActivity;
import com.example.liftapp.workout.workout_template.WorkoutTemplate;
 ...
 * @version 0.1
 */
public class StartWorkoutFromRoutinesActivity extends AppCompatActivity implements StartWorkoutFromRoutinesPresenter.View {

    /**
     * Activates when this activity is created
     *
     * @param savedInstanceState Bundle representing a storage for anything that might have been
     *                           stored previously
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new StartWorkoutFromRoutinesPresenter(this);
    }
